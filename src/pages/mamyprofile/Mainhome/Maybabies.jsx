...
//                 update
//               </button>
//               {/* ✅ فتح المودال بدل الحذف مباشرة */}
//               <button className="lab" style={{ color: textColor, borderColor: textColor }}
//                 onClick={() => { setDeleteId(e._id); setShowConfirm(true); }}>
//                 delete
//               </button>
//               <button className="media-responseve" onClick={() => { setupdate(true); setUpdateId(e._id); }}>
//                 <CiEdit style={{ color: textColor, borderColor: textColor }} />
...
//       {/* ✅ مودال الكونفيرم */}
//       {showConfirm && (
//         <div className="confirmation" onClick={() => setShowConfirm(false)}>
//           <div
//             className="modal"
...
//               <button className="confirm" onClick={handleConfirm}> delete</button>
...
export default function Maybabies() {
      ...
      {group.map((e, idx) => {
        ...
        return (
          <div key={idx} className="babycard" style={{ color: textColor }}>
            ...
            <div className="baby-options">
              <button className="lab" style={{ color: textColor, borderColor: textColor , cursor:"pointer" }}
                onClick={() => { setupdate(true); setUpdateId(e._id); }}>
                update
              </button>
              <button className="lab" style={{ color: textColor, borderColor: textColor, cursor:"pointer" }}
              ...
              <button className="media-responseve" onClick={() => { setupdate(true); setUpdateId(e._id); }}>
                <CiEdit style={{ color: textColor, borderColor: textColor, cursor:"pointer" }} />
              </button>
              <button className="media-responseve"
                onClick={() => { setDeleteId(e._id); setShowConfirm(true); }}>
                <TiDelete style={{ color: textColor, borderColor: textColor , cursor:"pointer" }} />
              </button>
            </div>
          </div>
        );
  ...
  <div className="confirmation" onClick={() => setShowConfirm(false)}>
    <div
      className={`modal ${closing ? "closing" : "opening"}`}
      onClick={(e) => e.stopPropagation()}
    >
      <h3>Are you sure you want to delete?</h3>
      <div className="actions">
        <button className="confirm" onClick={handleConfirm} disabled={isDeleting}>
          {isDeleting ? <div className="spinner-small"></div> : "Delete"}
        </button>
        <button
          className="cancel"
          onClick={() => {
