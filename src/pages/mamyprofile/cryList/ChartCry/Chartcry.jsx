...
//       <h3 style={{ textAlign: "center", color: "#0A6AA6", fontFamily: "Poppins", marginBottom: 8  , fontWeight:"500"}}>
...
export default function Chartcry({ cries }) {
  ...
  // simulate loading state (مثلاً بعد fetch حقيقي أو مجرد انتظار بسيط)
  useEffect(() => {
    const timeout = setTimeout(() => {
      setLoading(false);
    }, 1000); // هنا بنأخره 1 ثانية – غير الرقم حسب الحاجة
